  ...
  return (
    <Container>
      ...
      <footer className="h-28 w-full mb-20">
        <div className="flex mb-10 w-[25%] justify-between max-lg:gap-2">
        ...
        <div className="flex justify-between w-[55%] mb-10 max-sm:w-full max-sm:flex-col max-lg:w-full max-lg:px-4">
